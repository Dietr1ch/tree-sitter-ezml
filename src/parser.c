...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 3),
  [25] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 3),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 4),
  [29] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 4),
  ...
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 5),
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 5),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2),
  [47] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(10),
  [50] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(13),
  [53] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(10),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_element_repeat1, 2),
  [58] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_element_repeat1, 2),
  [60] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_element_repeat1, 2), SHIFT_REPEAT(34),
  ...
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag_name, 1),
  [80] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag_name, 1),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 2),
  [84] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag, 2),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_name, 1),
  [88] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attribute_name, 1),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 2),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attribute, 2),
  [94] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_value, 3),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attribute_value, 3),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 4),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attribute, 4),
  [104] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_content, 2),
  [110] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_content, 2),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_content, 3),
  [114] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_content, 3),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_content_repeat1, 2),
  [118] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_content_repeat1, 2), SHIFT_REPEAT(13),
  [121] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_content_repeat1, 2), SHIFT_REPEAT(28),
  [124] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [126] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 6),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 6),
